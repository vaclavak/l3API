package vpp.vac.l3lib.licensing;
...
public class License {
	...
	public License(String secret) {
		this.secret = secret;
	}
	
	/**
     * @author vaclavak
     * @return Returns a new license key based on the secret
     */
    public String generateLicenseKey() {
        ...
        String hmac = computeHMAC(data, salt);

        return saltStr + ":" + timestampStr + ":" + lettersStr + ":" + hmac;
    }

    private String computeHMAC(String data, byte[] salt) {
        try {
     ...
     * The key to validate
     * @return
     * If the key is valid based on the secret
     */

    public boolean validateKey(String licenseKey) {
        ...
        String data = saltStr + ":" + timestampStr + ":" + lettersStr;
        String expectedHmac = computeHMAC(data, salt);
